...
public class MiniBoss1 extends GameBase {
    int health = 10;
    public MiniBoss1() {
        super();
    }

    public MiniBoss1(Image imgs, int width, int height, int x_value, int y_value, double speed, GameRun gameWindow) {
        super(imgs, width, height, x_value, y_value, speed, gameWindow);
    }

    public MiniBoss1(Image imgs, int x_value, int y_value, double speed) {
